import PathFinder from "./addemployee";

const Footer = () => {
  // <PathFinder></PathFinder>
  return (
    <>
      <footer className="p-4 bg-gray-100 sm:p-6 dark:bg-gray-100">
        <div className="md:flex md:justify-between">
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
              <h2 className="mb-6 text-sm font-semibold text-gray-700 uppercase dark:text-gray-700">
                Resources
              </h2>
